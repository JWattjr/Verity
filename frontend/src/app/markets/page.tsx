...
export default function MarketsPage() {
  ...
  const { redeemWinnings, redeemMultipleWinnings } = useMarketResolution()
      ...
      {activeTab === "pvp-arena" && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-start">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4">
            {/* PvP Arena Skeleton Loader — shown during initial data fetch */}
            {(pvpEventsLoading || pvpStatusLoading) && (
              <div className="flex flex-col gap-4 animate-pulse">
                ...
                <div className="verity-card p-5 flex flex-col gap-4">
                  ...
                  {/* Event Selector Dropdown Skeleton */}
                ...
                <div className="verity-card overflow-hidden">
                  <div className="p-4 border-b border-border dark:border-zinc-800 bg-white-surface/40 dark:bg-zinc-900/40">
                    <div className="h-4 w-40 bg-stone-surface dark:bg-zinc-800 rounded" />
                    <div className="h-3 w-64 bg-stone-surface dark:bg-zinc-800 rounded mt-2" />
                  </div>
                  <div className="divide-y divide-border dark:divide-zinc-800">
                    {Array.from({ length: 3 }).map((_, i) => (
                      ...
                      >
                        <div className="space-y-2">
                          <div className="h-4 w-48 bg-stone-surface dark:bg-zinc-800 rounded" />
                          <div className="h-3 w-36 bg-stone-surface dark:bg-zinc-800 rounded" />
                        </div>
                        <div className="h-6 w-16 bg-stone-surface dark:bg-zinc-800 rounded" />
                      </div>
                    ))}
                  </div>
                </div>
                    ...
                    <div className="verity-card p-5 border border-sky-blue/30 dark:border-sky-blue/20 bg-gradient-to-br from-sky-blue/5 via-transparent to-transparent">
                      ...
                      <div className="mt-4 pt-4 border-t border-border dark:border-zinc-800 flex items-center justify-between">
                        <p className="text-xs text-ash">
                          Duel is resolved. XP and ELO updates have been
                          applied.
                        </p>
                        <button
            ...
            {!pvpEventsLoading &&
              ...
              (!pvpStatus ||
                ...
                (pvpStatus.status === "resolved" && showBuilderOverride) ||
                showBuilderOverride) && (
                <div className="verity-card p-5 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setSelectedPvpEventId(e.target.value)
                          }
