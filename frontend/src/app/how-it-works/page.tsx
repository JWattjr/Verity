    ...
    <div className="flex flex-col gap-3 py-3 sm:py-4">
      <section className="verity-card relative overflow-hidden p-5 sm:p-8">
        ...
        <div className="relative max-w-[620px]">
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            ...
            <Link
              className="verity-pill flex h-11 items-center bg-parchment-card px-5 text-sm font-semibold tracking-[-0.18px] text-charcoal-primary shadow-subtle transition-colors hover:bg-stone-surface"
              href="/explore"
            >
              Explore markets
            </Link>
      ...
      <section className="verity-card p-4 sm:p-5">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          {SOCIAL.map((item) => (
            <article
              className="rounded-[12px] bg-parchment-card p-4 shadow-subtle"
              key={item.title}
            >
