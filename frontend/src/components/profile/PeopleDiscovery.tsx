            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col gap-1.5">
                  <div className="h-3.5 w-24 rounded-[2px] bg-stone-surface" />
                  <div className="h-3 w-16 rounded-[2px] bg-stone-surface" />
                </div>
              </div>
              <div className="h-8 w-16 rounded-[2px] bg-stone-surface" />
            </div>
          ))}
        </div>
      ) : people.length > 0 ? (
