...
export default function WalletConnectControl() {
  ...
  return (
    <button
      className="verity-pill flex h-11 w-full items-center justify-center gap-2 bg-parchment-card px-4 text-sm font-semibold tracking-[-0.18px] text-charcoal-primary shadow-subtle transition-colors hover:bg-stone-surface cursor-pointer"
      onClick={logout}
      type="button"
